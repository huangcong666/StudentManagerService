...
<body>
	...
	<div class="easyui-panel" title="忘记密码" style="width:100%;max-width:400px;padding:30px 60px;">
		<form id="ff" method="post" action="StudentForget.action">
			<div style="margin-bottom:20px">
				<input id="number" class="easyui-textbox" name="number" style="width:100%" data-options="label:'学号:'" required="" missingMessage="不能为空">
			</div>
			<div style="margin-bottom:20px">
