...
<body>
	...
	<div class="easyui-panel" title="教师登录" style="width:100%;max-width:400px;padding:30px 60px;">
		<form id="ff" method="post" action="TeacherLogin.action">
			...
			<a href="tforget.jsp" class="easyui-linkbutton"  style="width:80px;margin-left: 4px;" id="tforget">忘记密码</a>
			</div>
		</form>
